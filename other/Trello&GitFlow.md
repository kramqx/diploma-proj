...
| Тип ветки    | Откуда отводится | Куда мержится  | Комментарий                                |
| ------------ | ---------------- | -------------- | ------------------------------------------ |
| **main/**    | —                | —              | Продакшен, стабильная ветка                |
| **develop/** | —                | —              | Основная рабочая ветка для фич и багфиксов |
| **feature/** | develop          | develop        | Новые фичи, обычно через PR                |
| **bugfix/**  | develop          | develop        | Исправления багов в develop, PR в develop  |
| **hotfix/**  | main             | main и develop | Срочные исправления в продакшене           |
| **release/** | develop          | main           | Подготовка релиза, тестирование, PR в main |
